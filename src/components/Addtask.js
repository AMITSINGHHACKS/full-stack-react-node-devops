...
export default function Addtask() {
  return (
    <>
    <div className="relative flex h-10 w-full min-w-[200px] max-w-[24rem] mx-auto">
  <input
    type="email"
  ...
  />
  <button
    className="!absolute right-1 top-1 z-10 select-none rounded bg-white py-2 px-4 text-center align-middle font-sans text-xs font-bold uppercase text-white shadow-md shadow-white transition-all hover:shadow-lg hover:shadow-white focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none peer-placeholder-shown:pointer-events-none peer-placeholder-shown:bg-blue-gray-500 peer-placeholder-shown:opacity-50 peer-placeholder-shown:shadow-none text-black"
    type="button"
